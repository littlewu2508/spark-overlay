...
inherit cmake-utils multilib python-r1 perl-module
...
src_prepare() {
	...
	sed -e "/set(CMAKE_INSTALL_DIR/s|lib/cmake|${libdir}/cmake|" -i build/cmake/DefineInstallationPaths.cmake || die
